...
let readOrCreateJsonFile = (filePath: string, newData?: Record<string, any>) => {
...
export let updateJsonFile = (filePath: string, collection_id: any, key: string, value: any) => {
